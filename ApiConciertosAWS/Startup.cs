...
namespace ApiConciertosAWS
{
    public class Startup
    {
        ...
        {
            string cadena = Configuration.GetConnectionString("AWSMariaDB");
            services.AddTransient<RepositoryEventos>();
            services.AddDbContext<EventosContext>(options => options.UseMySql(cadena, ServerVersion.AutoDetect(cadena)));
            services.AddCors(x =>
            {
